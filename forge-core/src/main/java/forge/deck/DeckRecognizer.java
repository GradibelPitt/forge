...
public class DeckRecognizer {
    ...
    public static final String REX_CARD_NAME = String.format("(\\[)?(?<%s>[\\p{L}\\p{M}0-9_·，—&',\\.:!\\?\\+\\\"\\/\\-\\s]+)(\\])?", REGRP_CARD);
    // TOKEN_HS is an eight-character DIY edition code.
    public static final String REX_SET_CODE = String.format("(?<%s>[a-zA-Z0-9_]{2,8})", REGRP_SET);
    /**
