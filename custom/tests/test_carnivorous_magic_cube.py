...
ART_OUTPAINT = (
    ...
    / "tools"
    / "card-artwork"
    / "食肉魔块-imagegen-outpaint-20260806.png"
)
ART = ROOT / "cards" / "pictures" / "PH01" / "食肉魔块.artcrop.jpg"
ZH_CN = FORGE_ROOT / "forge-gui" / "res" / "languages" / "cardnames-zh-CN.txt"

ORACLE = (
    "当食肉魔块进战场时，消灭目标由你操控的生物。\\n"
    "当食肉魔块死去时，将两张以此法被消灭之生物的复制品化生到战场上。"
)
...
class CarnivorousMagicCubeContractTest(unittest.TestCase):
    ...
    def test_registration_localization_art_and_documentation(self):
        ...
        self.assertEqual(
            "84305E6A90CB662569E6449901D7F51A79773EE3A08E7024884BE5F68A76B45D",
        ...
        self.assertEqual(
            "C4F265F4F24042E532BA6550E5FD74BDCA1714B77B613ABEA17455BF2A14F6EE",
