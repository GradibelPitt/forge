...
Assert ((Get-UpdateDecision 'M' 'forge-gui-desktop/src/main/java/forge/view/UI.java') -eq 'skip') 'UI preserved'
Assert ((Get-UpdateDecision 'M' 'forge-core/src/main/java/forge/util/CardTranslation.java') -eq 'skip') 'DIY translations preserved'
