...
public enum Keyword {
    ...
    BOARDING("Boarding", Boarding.class, false, "Once %d or more different friendly characters have been dealt damage this turn, put this card from your hand or library onto the battlefield under your control. This action doesn't use the stack."),
    ...
    DECK_MINIMUM("DeckMinimum", KeywordWithAmount.class, false, "Your main deck must contain at least %d cards."),
    ...
    DURABILITY("Durability", KeywordWithAmount.class, false, "This permanent enters with {%d:durability counter} on it. When the last durability counter is removed from it, sacrifice it."),
    ...
    IGNORE_DECK_LIMITS("IgnoreDeckLimits", SimpleKeyword.class, true, "Your main deck may contain any number of cards and any number of cards with the same name."),
    IGNORE_SUPERREACH("Ignore Superreach", SimpleKeyword.class, true, "Creatures with superreach can't ignore this creature's blocking restrictions."),
    ...
    SUPERREACH("Superreach", SimpleKeyword.class, true, "This creature can block any number of attacking creatures and ignores blocking restrictions from those attackers unless they have ignore superreach."),
